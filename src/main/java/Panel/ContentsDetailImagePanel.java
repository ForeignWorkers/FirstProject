...
public class ContentsDetailImagePanel extends JPanel {
	...
	public ContentsDetailImagePanel(ItemVO content) {
		...
		// 이미지 라벨
		JLabel ImageLabel = new JLabel(DataManagers.getInstance().getIcon("thumbnailBG", "detail_Content_Page"));
		ImageLabel.setLayout(null);
		ImageLabel.setBounds(405, 30, 129, 161);
		// 평점 및 리뷰 개수
		...
		JLabel reviewLabel = new JLabel("(리뷰 개수)");
		...
		// 제작년도
		JLabel yearLabel = new JLabel("제작년도 : ");
		...
		JLabel PromotionDayLabel2 = new JLabel("2015.01.20");
		...
		JLabel rateLabel2 = new JLabel("18+");
		...
		JLabel runningTimeLabel2 = new JLabel("180min");
		...
		JLabel nationLabel2 = new JLabel("일본");
		...
		JLabel DirectorActorLabel2 = new JLabel("이마다료/니지카");

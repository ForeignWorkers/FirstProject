...
public class ReviewPanel4 extends JPanel {
    ...
    public ReviewPanel4() {
        ...
        JPanel starPanel = new JPanel(new GridLayout(1, 5)); // 별점 버튼을 한 줄로 배치
    ...
    private void toggleSubmitButton() {
        submitButton.setEnabled(reviewInput.getText().length() >= 5);
    }
